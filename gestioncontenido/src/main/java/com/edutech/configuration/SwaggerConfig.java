...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Contenido - Edutech")
                        .version("1.0.0")
                        .description("Microservicio de gestión de contenido - Subir, actualizar y visualizar contenido"))
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/doc/swagger/contenido/**")
