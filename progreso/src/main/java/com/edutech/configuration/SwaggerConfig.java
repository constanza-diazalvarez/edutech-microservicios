...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Progreso - Edutech")
                        .version("1.0.0")
                        .description("Microservicio de progreso - Registra el progreso que llevan los estudiantes en sus cursos"))
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/doc/swagger/progreso/**")
