...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Inscripción - Edutech")
                        .version("1.0.0")
                        .description("Microservicio de inscripción - Inscripción a curso, visualizar cursos inscritos y visualizar contenido de un curso inscrito"))
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/doc/swagger/inscripcion/**")
